...
python process_asr_text_tokenizer.py \
  --manifest="/media/sayan/hdd/ARS/whisper/dataset/train.json" \
  --data_root="/media/sayan/hdd/ARS/nemo_experiment" \
  --vocab_size=1024 \
  --tokenizer="spe" \
  --no_lower_case \
  --spe_type="bpe" \
...
parser.add_argument("--spe_byte_fallback", default="<unk>",  help='Type of spe byte fallback')
parser.add_argument(
    "--spe_type",
    default="bpe",
